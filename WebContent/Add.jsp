...
<br/>
  <div class="form-group row text-center">
    ...
    <div class="col-sm-2 text-center">
      <input type="text" class="form-control" id="inputPassword" placeholder="Name" required="required"  name="name">
    </div>
  </div>
<br/>
  <div class="form-group row text-center">
    ...
    <div class="col-sm-2 text-center">
      <input type="text" class="form-control" id="inputPassword" placeholder="Price"  required="required" name="price">
    </div>
  </div>
<br/>
  <div class="form-group row text-center">
    ...
    <div class="col-sm-2 text-center">
      <input type="text" class="form-control" id="inputPassword" name="quantity"  required="required" placeholder="Quantity">
    </div>
  </div>
<br/>
  <div class="form-group row text-center">
    ...
    <div class="col-sm-2 text-center">
      <input type="text" class="form-control" id="inputPassword" name="discount" required="required" placeholder="Discount">
    </div>
  </div>
<br/>
  <div class="form-group row text-center">
	    <button type="submit" class="col-sm-1 btn btn-primary offset-3">Register</button>
